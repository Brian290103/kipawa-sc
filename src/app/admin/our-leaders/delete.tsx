...
import { deleteLeadersSectionData } from "@/actions/ourLeadersSectionActions"; // Import the server action
...
const DeleteData = ({ id }: { id: string }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteLeadersSectionData(id); // Call the server action
    } finally {
